...
(let-signal (S1 #:combine + S2 #:combine +)
  (define r
    (reaction
     (emit S1 11)
     (pause)
...
;; popl 2019 figure 7
(let-signal (sl1 sl2 sl3 so1 so2)
  (define r
    (reaction
     (par
      (if (present? sl1)
