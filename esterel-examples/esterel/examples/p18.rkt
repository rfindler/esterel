...
This is a wild program that has an explanation in Berry's _The Constructive Semantics of Pure Draft Version 3_ (quote and program below taken from pages 137-9):

So far, we have seen cases where a statement has two simultaneous incarnations. Nesting loops, traps, and parallel statements can lead to more complex situations with multiple reincarnation of parallels and signals. Consider this program, P18. In the first instant, the three pause statements are selected, S1 and S2 are not emitted, and not_S1_and_not_S2 is emitted. In the second instant, the constructive behavior is as follows:
